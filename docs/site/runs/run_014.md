...
### Grid run_014 vs truth

Comparació directa del grid voxelitzat entre el run_014 i les dades de referència (Geant4).

#### Grid run_014

![Grid run_014](../images/runs/diagnose_run_014/voxel/emap_grid.png)

- [Veure grid truth complet](../truth.md)

### Directors d'individus

- [run_014 — emaps individuals](../images/runs/diagnose_run_014/voxel/)
...
![E_mean(z) grid](../images/runs/diagnose_run_014/voxel/profile_emean_z_grid.png)

### Directors d'individus

- [run_014 — profiles individuals](../images/runs/diagnose_run_014/voxel/)
...
![E_total(z) grid](../images/runs/diagnose_run_014/voxel/profile_z_grid.png)
