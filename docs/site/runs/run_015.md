...
### Grid run_015 vs truth

Comparació directa del grid voxelitzat entre el run_015 i les dades de referència (Geant4).

#### Grid run_015

![Grid run_015](../images/runs/diagnose_run_015/voxel/emap_grid.png)

- [Veure grid truth complet](../truth.md)

### Directors d'individus

- [run_015 — emaps individuals](../images/runs/diagnose_run_015/voxel/)
...
![E_mean(z) grid](../images/runs/diagnose_run_015/voxel/profile_emean_z_grid.png)

### Directors d'individus

- [run_015 — profiles individuals](../images/runs/diagnose_run_015/voxel/)
...
![E_total(z) grid](../images/runs/diagnose_run_015/voxel/profile_z_grid.png)
