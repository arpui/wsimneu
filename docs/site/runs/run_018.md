...
### Grid run_018 vs truth

Comparació directa del grid voxelitzat entre el run_018 i les dades de referència (Geant4).

#### Grid run_018

![Grid run_018](../images/runs/diagnose_run_018/voxel/emap_grid.png)

- [Veure grid truth complet](../truth.md)

### Directors d'individus

- [run_018 — emaps individuals](../images/runs/diagnose_run_018/voxel/)
...
![E_mean(z) grid](../images/runs/diagnose_run_018/voxel/profile_emean_z_grid.png)

### Directors d'individus

- [run_018 — profiles individuals](../images/runs/diagnose_run_018/voxel/)
...
![E_total(z) grid](../images/runs/diagnose_run_018/voxel/profile_z_grid.png)
