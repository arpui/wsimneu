...
### Grid run_016 vs truth

Comparació directa del grid voxelitzat entre el run_016 i les dades de referència (Geant4).

#### Grid run_016

![Grid run_016](../images/runs/diagnose_run_016/voxel/emap_grid.png)

- [Veure grid truth complet](../truth.md)

### Directors d'individus

- [run_016 — emaps individuals](../images/runs/diagnose_run_016/voxel/)
...
![E_mean(z) grid](../images/runs/diagnose_run_016/voxel/profile_emean_z_grid.png)

### Directors d'individus

- [run_016 — profiles individuals](../images/runs/diagnose_run_016/voxel/)
...
![E_total(z) grid](../images/runs/diagnose_run_016/voxel/profile_z_grid.png)
