...
| focal_gamma | 0.0 |
| sum_scale_nmax | True |
| Checkpoint | [ckpt_final.pt](../../runs/nc_multiE/run_018/ckpt_final.pt) |
...
![A — Transforms](../../docs/vault/results/figures/diagnose_run_018/A_transforms.png)

### B — Z per energia (truth)

Distribució de z per energia en les dades de veritat.

![B — Z per energia](../../docs/vault/results/figures/diagnose_run_018/B_z_per_energy_truth.png)

### C — Z físic

Distribució de z en unitats físiques (truth vs generated).

![C — Z físic](../../docs/vault/results/figures/diagnose_run_018/C_z_phys.png)

### D — Scatter edep vs z

Relació entre edep i z (scatter plots).

![D — Scatter](../../docs/vault/results/figures/diagnose_run_018/D_edep_vs_z_scatter.png)

### E — Perfil edep vs z

Perfil de edep al llarg de z.

![E — Perfil](../../docs/vault/results/figures/diagnose_run_018/E_edep_z_profile.png)
